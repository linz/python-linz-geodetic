...
class SinexTestCase( fileunittest.TestCase ):
    ...
    def test001_ReaderSolutionId( self ):
        ...
        self.check("test001: getSolutionsIds(KAIK,A)",snx.getSolutionIds(ptid='KAIK',ptcode='A'))
        self.check("test001: getSolutionsIds(KAIK,B)",snx.getSolutionIds(ptid='KAIK',ptcode='B'))
        #self.check("test001: getSolutionIds(A)",snx.getSolutionIds(ptcode='A'))
        self.check("test001: getSolutionIds(KAIK,1)",snx.getSolutionIds(ptid='KAIK',solnid='1'))
        self.check("test001: getSolutionIds(KAIK,2)",snx.getSolutionIds(ptid='KAIK',solnid='2'))
    ...
    def test004_ReaderXYZ( self ):
        ...
        self.checkRun("test004: no covar xyz KAIK with covar",lambda:snx.xyz('KAIK',covariance=True))
    ...
    def test006_WriteSindex( self ):
        ...
        with Sinex.Writer(filename) as snxf:
            ...
            snxf.addSolution('12cd',[-4685480.3689522203,   531054.576640439 , -4280819.1694681998],[0,1,2])
            snxf.addSolution('ax1d',[-46854280.3689522203,   531354.576640439 , -4280849.1694681998],[3,4,5])
            snxf.setCovariance([[ 0.0000003003, -0.0000000264,  0.0000002349,  0.0000000094,
                    0.0000000012, -0.0000000004, -0.0000000006,  0.0000000032],
                [-0.0000000264,  0.0000000159, -0.0000000218, -0.0000000006,
                    0.0000000001,  0.0000000002,  0.000000001 , -0.0000000001],
                [ 0.0000002349, -0.0000000218,  0.0000002229,  0.0000000062,
                    0.0000000011, -0.0000000016, -0.0000000001,  0.0000000027],
                [ 0.0000000094, -0.0000000006,  0.0000000062,  0.0000001599,
                    -0.000000014 ,  0.0000001283, -0.000000076 ,  0.0000000078],
                [ 0.0000000012,  0.0000000001,  0.0000000011, -0.000000014 ,
                    0.0000000084, -0.0000000119,  0.0000000078, -0.0000000039],
                [-0.0000000004,  0.0000000002, -0.0000000016,  0.0000001283,
                    -0.0000000119,  0.0000001238, -0.0000000612,  0.0000000065]])
